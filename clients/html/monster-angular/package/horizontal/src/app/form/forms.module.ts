...
@NgModule({
  imports: [CommonModule, ReactiveFormsModule, NgbModule, RouterModule.forChild(FormsRoutes), FormsModule, NGXFormWizardModule, NgMultiSelectDropDownModule.forRoot(), CustomFormsModule, ArchwizardModule],
  declarations: [
    FormBasicComponent,
    FormvalComponent,
    CheckradioComponent,
