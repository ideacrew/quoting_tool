...
module Parsers
  module Products
    # Parser for MaximumOutOfPockets
      ...
      def to_hash
        {
          ...
          in_network_tier_2_individual_amount: in_network_tier_2_individual_amount.present? ? in_network_tier2_individual_amount.gsub(/\n/, '').strip : '',
          in_network_tier_2_family_amount: in_network_tier_2_family_amount.present? ? in_network_tier2_family_amount.gsub(/\n/, '').strip : '',
