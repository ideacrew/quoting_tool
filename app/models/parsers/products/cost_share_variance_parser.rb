...
module Parsers
  module Products
    ...
    class CostShareVarianceParser
      ...
      has_one :sbc_attributes, Parsers::Products::SbcParser, tag: 'sbc'
      has_many :maximum_out_of_pockets_attributes, Parsers::Products::MaximumOutOfPocketsParser, tag: 'moop', deep: true
      has_one :deductible_attributes, Parsers::Products::DeductibleParser, tag: 'planDeductible', deep: true
      has_many :service_visits_attributes, Parsers::Products::ServiceVisitsParser, tag: 'serviceVisit', deep: true
      has_one :hsa_attributes, Parsers::Products::HsaParser, tag: 'hsa', deep: true
